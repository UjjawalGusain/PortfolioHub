...
export default function CardDefault({thumbnailUrl, githubUrl, description}) {
  return (
      ...
      <img
        className="h-96 w-full rounded-t-lg object-cover md:h-72 md:w-48 md:rounded-none md:rounded-l-lg"
        src="C:/Users/Lenovo/OneDrive/Pictures/Screenshot 2023-12-06 213819.png"
        alt="" />
