...
function Footer() {
  return (
    <div className="h-32 text-home-black flex flex-col justify-center items-center p-8 z-20 sticky bottom-0 bg-white">
      <div className="flex w-1/2 pt-5 pb-2 border-t-2 text-3xl justify-center items-center gap-20">
        <a
